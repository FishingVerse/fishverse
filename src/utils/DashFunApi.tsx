...
const api_prod = "https://server.fishing-verse.com/api/v1/"
...
const api_url = () => {
	...
	if (url.indexOf("https://tma.fish-verse.com") >= 0 || url.indexOf("https://tma.fishing-verse.com") >= 0) {
		env = Env.Prod

		return api_prod;
	}
	if (url.indexOf("https://app.fish-verse.com") >= 0 || url.indexOf("https://app.fishing-verse.com") >= 0) {
		env = Env.Prod
